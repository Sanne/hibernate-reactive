 ...
 * on the generated IDs to be unique; both tests are interesting as:
 *  - ID generation needs to be unique so it's good to stress that in isolation
...
public class MultithreadedInsertionTest {
	...
	private static final int ENTITIES_STORED_PER_THREAD = 3000;
